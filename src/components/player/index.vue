    ...
    <div class="player" v-show="playlist.length>0">
        <transition name="normal" @enter="enter" @after-enter="afterEnter" @leave="leave" @after-leave="afterLeave">
            <div class="normal-player" v-show="fullScreen">
                ...
                <div class="middle" @touchstart.prevent="middleStart" @touchmove.prevent="middleMove" @touchend="middleEnd">
                ...
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progress-bar @percentChange="progressPercentChange" :percent="percent"></progress-bar>
                        </div>
                        <span class="time time-r">{{currentSong.duration | format}}</span>
                    </div>
                    <div class="operators">
                        <div class="icon i-left">
                            <i @click="changeMode" class="icon" :class="modeClass"></i>
                        </div>
        ...
        <transition name="mini">
            <div class="mini-player" v-show="!fullScreen" @click="setFullScreen(true)">
                <div class="icon">
                    <img :class="cdClass" width="40" height="40" ref="miniImg" :src="currentSong.image">
                </div>
                <div class="text">
        ...
        <audio ref="audio" autoplay="true" :src="currentSong.url" @play="sReady" @error="sError" @timeupdate="timeupdate" @ended="end"></audio>
    </div>
...
<script type="text/ecmascript-6">
    ...
    import { pad, shuffle, findIndex } from '@/common/js/util'
    ...
    export default {
        ...
        created() {
            this.touch = { startX: 0, startY: 0, percent: 0 };
        },
        methods: {
            enter(el, done) {
            ...
            leave(el, done) {
                ...
                this.$refs.cdWrapper.addEventListener('animationend', this.leaveAnimation, false);
            },
            afterLeave(el) {
                this.$refs.cdWrapper.removeEventListener('animation', this.leaveAnimation, false);
                this.$refs.cdWrapper.style[transform] = '';
            ...
            getPosAndScale() {
                ...
                const PADDINGTOP = 80;
                var x = PADDINGLEFT - window.innerWidth / 2;
                var y = window.innerHeight - PADDINGTOP - MAX_WIDTH / 2 - PADDINGBOTTOM;
            ...
            middleMove(e) {
                ...
                let left = this.currentShow === 'cd' ? 0 : -maxWidth;
                let offsetWidth = Math.min(0, Math.max(-maxWidth, left + disX));
                this.touch.percent = Math.abs(offsetWidth / maxWidth);
