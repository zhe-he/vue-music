    ...
    <transition name="slide">
        <div class="add-song" @click.stop v-show="showFlag">
            ...
            <div class="search-box-wrapper">
                <search-box :show-singer="showSinger" ref="searchBox" @query="updateQuery" placeholder="搜索歌曲"></search-box>
            </div>
            ...
            <div class="search-result" v-show="query">
                <suggest @select="selectSuggest" @listScroll="blurInput" :query="query"></suggest>
            </div>
            <top-tip ref="topTip">
                <div class="tip-title">
                    <i class="icon-ok"></i>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        computed: mapGetters(['playHistory']),
        methods: {
            show() {
                this.showFlag = true;
                this.$nextTick(() => {
